    ...
    <div className="min-h-screen flex items-center justify-center overflow-hidden relative bg-black p-0 m-0">
      ...
      <div className="fixed inset-0 w-full h-full">
        ...
        <div className="absolute inset-0 overflow-hidden z-0">
          <motion.div
            ...
            className="absolute -right-64 -top-64 w-[500px] h-[500px] rounded-full bg-gradient-to-r from-green-400/30 to-emerald-600/10 blur-3xl"
          />
          <motion.div
            initial={{ x: "-100%", y: "-100%", opacity: 0 }}
            animate={{ x: "-20%", y: "-20%", opacity: 0.15 }}
            transition={{ duration: 2, delay: 0.5 }}
            className="absolute -left-64 -bottom-64 w-[500px] h-[500px] rounded-full bg-gradient-to-r from-yellow-400/20 to-orange-500/10 blur-3xl"
          />
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            {/* Glow effects */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[100px] bg-green-500/20 blur-3xl rounded-full"></div>
              ...
              >
                  ...
                  <div className="mb-5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-black/50 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all placeholder-gray-500"
                ...
                >
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 border-gray-700 rounded text-green-600 focus:ring-green-500 bg-black/50"
                    />
                ...
                >
                  <motion.button
                    type="submit"
                    disabled={loading}
                    className={`group relative w-full flex justify-center py-3 px-4 text-sm font-medium rounded-xl text-black bg-gradient-to-r from-green-400 to-emerald-500 hover:from-green-500 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] ${
                      loading ? 'opacity-70 cursor-not-allowed' : ''
                    }`}
                    whileHover={{ scale: loading ? 1 : 1.03, boxShadow: "0 0 30px rgba(16,185,129,0.5)" }}
                  ...
                  >
                    ...
                    {!loading && (
                      <motion.span
                        className="absolute inset-0 rounded-xl bg-gradient-to-r from-green-400/40 to-emerald-500/40 blur"
